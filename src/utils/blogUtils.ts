...
export const getAllPosts = (): BlogPost[] => {
  const posts: BlogPost[] = [
    {
      slug: "this-loveable-portofolio",
      title: "This Loveable Portfolio",
      excerpt:
        "🏗️ The good, the bad and the insights from building this site with AI",
      date: "2025-03-03",
    ...
    },
    {
      ...
      excerpt:
        "🔥 is crypto a solution-without-a-problem or can we find a hair on fire problem it can solve?",
      date: "2020-09-11",
    ...
    },
    {
      ...
      excerpt:
        "📖 Exploration of a theory that the US's presidential system will converge to chaos.",
      date: "2020-09-11",
    ...
    },
    {
      ...
      excerpt:
        "👶 The less context your code needs to be understood; the better is scales.",
      date: "2020-09-11",
      readingTime: "3 min read",
    ...
    },
    {
      ...
      excerpt:
        "😱 Ether prices plummet and people want to get theirs out of the validation stakes; what will happen to the network?",
      date: "2020-09-11",
      readingTime: "5 min read",
